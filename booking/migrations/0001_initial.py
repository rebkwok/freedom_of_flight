    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', django_extensions.db.fields.AutoSlugField(blank=True, editable=False, max_length=40, populate_from=['name', 'start'], unique=True)),
                ...
                ('course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='booking.Course')),
            ],
            options={
                'ordering': ['-start'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('baseblockconfig_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='booking.BaseBlockConfig')),
            ],
            bases=('booking.baseblockconfig',),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='course_block_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='course_gift_vouchers', to='booking.CourseBlockConfig'),
        ),
        migrations.AddField(
            model_name='giftvouchertype',
            name='dropin_block_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dropin_gift_vouchers', to='booking.DropInBlockConfig'),
        ),
        ...
        migrations.AddField(
            ...
            name='block_types',
            field=models.ManyToManyField(to='booking.DropInBlockConfig'),
        ),
        migrations.AddField(
            model_name='blockvoucher',
            name='course_types',
            field=models.ManyToManyField(to='booking.CourseBlockConfig'),
        ),
        migrations.AddField(
            model_name='block',
            name='course_block_config',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='booking.CourseBlockConfig'),
        ),
        migrations.AddField(
            model_name='block',
            name='dropin_block_config',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='booking.DropInBlockConfig'),
        ),
        migrations.AddIndex(
            model_name='block',
