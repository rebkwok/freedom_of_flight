...
from .gift_vouchers import GiftVoucherPurchaseView, GiftVoucherUpdateView, GiftVoucherDetailView, voucher_details, gift_voucher_delete
...
from .shopping_basket_views import shopping_basket, ajax_checkout, stripe_checkout, check_total