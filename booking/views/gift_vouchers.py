...
from ..models import BlockVoucher, TotalVoucher, GiftVoucher
...
#                 voucher = TotalVoucher.objects.get(code=self.kwargs["voucher_code"])
...
#                     old_voucher_type = GiftVoucher.objects.get(block_config=voucher.block_configs.first())
#                 else:
