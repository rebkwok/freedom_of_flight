...
urlpatterns = [
    ...
    path('site-config/disabled-credit-blocks/', disabled_block_config_list_view, name="disabled_block_configs"),
    ...
    path('site-config/credit-block/<int:block_config_id>/enable/', enable_block_config, name="enable_block_config"),
    path('site-config/credit-block/<int:block_config_id>/disable/', disable_block_config, name="disable_block_config"),
