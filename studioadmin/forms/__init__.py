from .forms import (
    AddEditBookingForm, AddEditBlockForm, AddEditSubscriptionForm, AddRegisterBookingForm,
    BlockConfigForm, BookableEventTypesForm, CourseBookingAddChangeForm,
...
from .voucher_forms import BlockVoucherStudioadminForm
