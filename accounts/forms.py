...
class DisclaimerForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            HTML(f"<h3>{self.disclaimer_content.form_title}</h3>") if self.disclaimer_content.form else HTML(""),
            "health_questionnaire_responses",
            HTML(f"<p>{self.disclaimer_content.form_info}</h3>") if self.disclaimer_content.form_info else HTML(""),
